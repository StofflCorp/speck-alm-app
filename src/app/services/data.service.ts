...
export class DataService {
  ...
  async addToCart(userId, productId, quantity) {
    ...
    const response: any = await this.http.post(`https://speckalm.htl-perg.ac.at/r/api/users/${userId}/shoppingCart?token=${this.globalService.getToken()}`, postData).toPromise();
